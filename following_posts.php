...
$query="SELECT * FROM followers WHERE  user1 = '$username'";
...
<div class="container">
  ...
  <div class="card" style="width:400px">
    <div class="card-body">
      <h4 class="card-title"><?php echo htmlspecialchars($row['following']); ?></h4>
      <?php 
...
?>
      <a class="btn btn-primary" <?echo ' href="following_answers.php?following=' . $row['following'] . '">View Answers</a>'?>
