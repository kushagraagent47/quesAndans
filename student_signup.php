...
<form action="student_signup.php" method="post" style="border:1px solid #ccc">
  <div class="container">
    ...
    <label for="course">course you are intrested in</label>
...
<?php
  ...
  if ($result->num_rows > 0) {
    ...
    echo "Username already in use";
      ...
      $sql = "INSERT INTO users (name, username, email, course , password, hash) " 
              . "VALUES ('$name','$username','$email', '$course', '$password','$hash')";
