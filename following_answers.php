...
$answer = $_GET['following'];
$course = $_SESSION['course'];
$username = $_SESSION['username'];
$query="SELECT * FROM questions WHERE  answered_by = '$answer'";
...
<div class="container">
  ...
  <div class="card" style="width:400px">
    <div class="card-body">
      <h4 class="card-title"><?php echo htmlspecialchars($row['question']); ?></h4>
      <?php 
...
?>
      <a class="btn btn-primary" <?echo ' href="following_answer.php?ques=' . $row['question'] . '">View Answer</a>'?>
